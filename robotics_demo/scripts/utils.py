...
from robotics_demo.msg import FullState, ToRecord, QuaternionProprioState, PositionCommand, Goal, TimerBeat, RPYProprioState, AchievedGoal, ResetInfo
...
def proprio_quat_to_rpy_vector(o: RPYProprioState):
