...
{
    public class MRPYProprioState : Message
    {
        public const string RosMessageName = "robotics_demo/RPYProprioState";
        ...
        public MRPYProprioState(float pos_x, float pos_y, float pos_z, float rot_r, float rot_p, float rot_y, float gripper)
        {
            this.pos_x = pos_x;
            this.pos_y = pos_y;
            this.pos_z = pos_z;
